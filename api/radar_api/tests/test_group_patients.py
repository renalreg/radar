...
from radar.models.groups import GROUP_TYPE_HOSPITAL, GROUP_TYPE_COHORT, GROUP_TYPE_OTHER, GROUP_CODE_RADAR
...
@pytest.mark.parametrize(['username', 'group_type', 'group_code', 'created_group_type', 'created_group_code', 'expected'], [
    ...
    ('null', GROUP_TYPE_HOSPITAL, 'HOSPITAL2', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', 403),
    ('null', GROUP_TYPE_COHORT, 'COHORT2', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', 403),
])
...
@pytest.mark.parametrize(['username', 'group_type', 'group_code', 'created_group_type', 'created_group_code', 'expected'], [
    ('admin', GROUP_TYPE_OTHER, GROUP_CODE_RADAR, GROUP_TYPE_HOSPITAL, 'HOSPITAL1', True),

    ('hospital1_clinician', GROUP_TYPE_COHORT, 'COHORT1', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', True),
    ('hospital1_clinician', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', True),
    ('hospital1_clinician', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', GROUP_TYPE_HOSPITAL, 'HOSPITAL2', True),
    ('hospital1_clinician', GROUP_TYPE_HOSPITAL, 'HOSPITAL2', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', False),
    ('hospital1_clinician', GROUP_TYPE_OTHER, GROUP_CODE_RADAR, GROUP_TYPE_HOSPITAL, 'HOSPITAL1', False),

    ('null', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', False),
    ('null', GROUP_TYPE_COHORT, 'COHORT1', GROUP_TYPE_HOSPITAL, 'HOSPITAL1', False),
])
def test_delete_group_patient(app, username, group_type, group_code, created_group_type, created_group_code, expected):
    user = get_user(username)

    radar_group = get_group(GROUP_TYPE_OTHER, GROUP_CODE_RADAR)
    group = get_group(group_type, group_code)
    created_group = get_group(created_group_type, created_group_code)
