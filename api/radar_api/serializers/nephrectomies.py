...
from radar.models.nephrectomies import Nephrectomy, NEPHRECTOMY_KIDNEY_SIDES, NEPHRECTOMY_KIDNEY_TYPES, NEPHRECTOMY_KIDNEY_TYPES


class NephrectomySerializer(PatientSerializerMixin, DataSourceSerializerMixin, MetaSerializerMixin, ModelSerializer):
    kindey_side = CodedStringSerializer(NEPHRECTOMY_KIDNEY_SIDES)
    kidney_type = CodedStringSerializer(NEPHRECTOMY_KIDNEY_TYPES)
    entry_type = CodedStringSerializer(NEPHRECTOMY_KIDNEY_TYPES)
