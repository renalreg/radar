(function() {
  ...
  app.directive('loading', ['session', 'LOADING_MESSAGES', '_', function(session, LOADING_MESSAGES, _) {
    return {
      restrict: 'A',
      scope: {
        loading: '='
      ...
      link: function(scope) {
        scope.$watch('loading', function() {
          if (session.user !== null && session.user.isAdmin) {
            scope.message = _.sample(LOADING_MESSAGES);
          } else {
