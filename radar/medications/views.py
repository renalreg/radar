...
app.add_url_rule('/<int:form_entry_id>/', view_func=MedicationDetailView.as_view('detail', 'medications/detail.html'))
app.add_url_rule('/<int:form_entry_id>/', view_func=MedicationDetailView.as_view('update', 'medications/detail.html'))
