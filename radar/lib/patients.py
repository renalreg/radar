...
def get_facility_patients(patient):
    ...
    facility_patient_map[radar_facility] = FacilityPatient(radar_facility, patient)
    ...
    facility_patients = sorted(facility_patient_map.values(), key=lambda x: x.facility.name)
