...
from cornflake.validators import max_length, none_if_blank, optional, range_, required
    ...
    def validate(self, data):
        ...
        if data["right_present"]:
            ...
            if data["right_calcification"]:
                self.run_validators_on_field(
                    data, "right_nephrocalcinosis", [required()]
                )
                self.run_validators_on_field(
                    data, "right_nephrolithiasis", [required()]
                )
        ...
        if data["left_present"]:
            ...
            if data["left_calcification"]:
                self.run_validators_on_field(
                    data, "left_nephrocalcinosis", [required()]
                )
