...
def register_views(app):
    ...
    app.add_url_rule(
        '/nephrectomy-kidney-sides',
        view_func=NephrectomyKidneySideListView.as_view('nephrectomy_kidney_side_list'))
    app.add_url_rule(
        '/nephrectomy-kidney-types',
        view_func=NephrectomyKidneyTypeListView.as_view('nephrectomy_kidney_type_list'))
    app.add_url_rule(
        '/nephrectomy-entry-types',
        view_func=NephrectomyEntryTypeListView.as_view('nephrectomy_entry_type_list'))
